...
test-docker: ## Run every test on every python on a docker image
	...
	docker run -it -v $(shell pwd):/opt/drmaa_futures drmaa_futures_test:latest su - sgeuser bash -c "cd /opt/drmaa_futures; tox"
	find drmaa_futures tests -name "*.pyc" -delete
...
docs: ## generate Sphinx HTML documentation, including API docs
	rm -f docs/drmaa_futures.rst
	rm -f docs/modules.rst
	sphinx-apidoc -o docs/ drmaa_futures
	$(MAKE) -C docs clean
	$(MAKE) -C docs html
